...
namespace Beelina.LIB.Helpers.Extensions
{
    public static class SystemExtensions
    {
        ...
        public static string ConvertUtcToLocalDateTime(this DateTime dateTime, string timeZoneId)
        {
            var timeZone = TimeZoneInfo.FindSystemTimeZoneById(timeZoneId);
            ...
            return localTime.ToString("yyyy-MM-dd HH:mm:ss"); // returns string without offset
        }
