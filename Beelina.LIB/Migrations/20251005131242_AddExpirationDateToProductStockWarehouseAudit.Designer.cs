...
namespace Beelina.LIB.Migrations
{
    ...
    [Migration("20251005131242_AddExpirationDateToProductStockWarehouseAudit")]
    partial class AddExpirationDateToProductStockWarehouseAudit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Beelina.LIB.Models.ProductWarehouseStockReceiptDiscount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProductWarehouseStockReceiptDiscounts");
                });
            ...
            modelBuilder.Entity("Beelina.LIB.Models.UserSetting", b =>
                {
                    ...
                    b.Property<int>("PrintReceiptFontSize")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Beelina.LIB.Models.ProductWarehouseStockReceiptDiscount", b =>
                {
                    ...
                    b.HasOne("Beelina.LIB.Models.ProductWarehouseStockReceiptEntry", "ProductWarehouseStockReceiptEntry")
                        .WithMany("Discounts")
                        .HasForeignKey("ProductWarehouseStockReceiptEntryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ProductWarehouseStockReceiptEntry");
