...
{
    /// <inheritdoc />
    public partial class IntroduceSPReport_Customer_Summary_Collection : Migration
    {
        /// <inheritdoc />
...
-- =============================================
-- EXEC Report_Sales_Agent_Summary_Collection @startDate='2024-06-01', @endDate = '2024-07-30', @salesAgentId='5', @userId='8'
CREATE OR ALTER PROCEDURE [dbo].[Report_Sales_Agent_Summary_Collection]
