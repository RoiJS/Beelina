...
{
    /// <inheritdoc />
    public partial class AlterTVFOrderTransactions20250603 : Migration
    {
        /// <inheritdoc />
...
BEGIN 
	...
	DECLARE @salesAgentType AS INT = COALESCE((SELECT u.SalesAgentType FROM UserAccounts u WHERE Id = @userId), 2) -- Default Warehouse Agent
    ...
    WHERE 
        (
            ...
            OR (@businessModel = 3 AND t.CreatedById = t.CreatedById AND u.SalesAgentType = @salesAgentType)
        )
