...
{
    /// <inheritdoc />
    public partial class AlterReportEndingInventoryPerProductAdmin20250603 : Migration
    {
        /// <inheritdoc />
...
BEGIN
	...
	IF @businessModel = 2
		EXEC Report_Ending_Inventory_Per_Product_Warehouse_Model_2 @startDate, @endDate, 0, @warehouseId

	IF @businessModel = 3
		EXEC Report_Ending_Inventory_Per_Product_Warehouse_Model_3 @startDate, @endDate, 0, @warehouseId
END	
