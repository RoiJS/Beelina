...
{
    public partial class IntroducedDailyDetailedTransactionsReportStoredProcedure : Migration
    {
...
CREATE PROCEDURE [dbo].[Report_Daily_Detailed_Transactions]
...
"
        ...
        {
            migrationBuilder.Sql("DROP PROCEDURE [dbo].[Report_Daily_Detailed_Transactions]");
        }
    }
}
