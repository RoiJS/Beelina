...
{
    public class ProductRepository_SalesAgent_WarehouseMonitoringModelTests : BeelinaBaseTest
    {
        ...
        public ProductRepository_SalesAgent_WarehouseMonitoringModelTests() : base()
        {
        ...
        public async Task GetProducts_NoProductFilter()
        {
            ...
            SetupCommonWarehousePanelMonitoringTestData(userId, PermissionLevelEnum.User, SalesAgentTypeEnum.FieldAgent, BusinessModelEnum.WarehouseMonitoring, cancellationToken);
        ...
        [Fact]
        public async Task GetProducts_WhenAllFiltersAreApplied()
        {
            // Arrange
            var userId = FieldAgent.Id;
            var productId = 0;
        ...
        [InlineData(1, 10, "Product 10 - Supplier 1", 290)]

        // Product without any linked Transaction
        [InlineData(2, 20, "Product 5 - Supplier 2", 300)]
        ...
        [Fact]
        public async Task GetProducts_CancellationToken()
        {
            // Arrange
            var userId = FieldAgent.Id;
            var productId = 0;
